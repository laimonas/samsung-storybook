import { ISTableColumn, SStatusBadge } from "../../../../components";


export const columns_edit: ISTableColumn[] = [
    {
        field: "image",
        header: "Vorschau",
        template: {
    ...
    },
    {
        ...
        filter: {
            ...
            selectedItemTemplate: (option) => {return(option? <SStatusBadge text={option} /> : "Select Item")},
            itemsTemplate: (option) => <SStatusBadge text={option.label} />,
        },
        sortable: true,
    },
    {
